...
<div class="wrap">
			...
			<table class="wpsc_checkout_table">
				...
				<tr>
					...
					<td>
						...
						<button value="<?php _e( 'Save Profile', 'wpsc' ); ?>" name="submit"><span><?php _e( 'Save Profile', 'wpsc' ); ?></span></button>
					</td>
				</tr>
			</table>
		</form>
	...
	<?php elseif ( is_wpsc_downloads_page() ) : ?>
		...
		<?php if ( wpsc_has_downloads() ) : ?>
				...
				<table class="logdisplay table wpsc_checkout_table">
					<tr>
	...
	<?php else : ?>
		...
		<?php if ( is_user_logged_in() ) : ?>
			...
			<?php else : ?>
				...
				<table class="table wpsc_checkout_table">
					<tr>
